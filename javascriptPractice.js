...
var netflixFavorites = {
    manga: 'Alita',
    science_fiction: 'Star Wars',
    documentary: 'March of the Penguins'
};

// function printResult(toBePrinted){
...
console.log(netflixFavorites['manga']);
console.log(netflixFavorites.science_fiction);
...
for(let appliance in kitchen) {
    console.log(appliance + ': ' + kitchen[appliance])
}
...
// for(movie in netflixFavorites){
//   console.log('My favorite netflix ' + movie + ' movie is ' + netflixFavorites[movie])
// }

for(movie in netflixFavorites){
    console.log(`My favorite netflix ${movie} is ${netflixFavorites[movie]}`)
}
...
kitchenArray = Object.entries(kitchen);
kitchenKeys = Object.keys(kitchen);
kitchenValues = Object.values(kitchen);
console.log(kitchenArray);
var mappedArray = kitchenArray.map(function(kitchenA){
    return kitchenA[1]
});
console.log(mappedArray);
console.log(kitchenKeys);
console.log(kitchenValues);
// var kitchen = {
//   microwave: {
//     brand: 'whirlpool',
//     yearsOld: 6,
